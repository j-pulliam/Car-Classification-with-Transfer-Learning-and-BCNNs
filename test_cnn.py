...
#Date: 8/27/2020
#Purpose: The purpose of this file is to evaluate the performance of a trained CNN over both the training and test datasets
...
if __name__ == '__main__':
    ...
    NN = createModel(model['model'], False)
